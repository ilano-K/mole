...
export default function SyncProgress({
  ...
  const progressPercentage = totalFiles > 0 ? Math.round((indexedFiles / totalFiles) * 100) : 0;
    ...
    <div className="sync-container">
      <div className="sync-card">
        ...
        <div className="sync-header">
          ...
          <p className="sync-subtitle">Reading and vectorizing your selected folder</p>
        </div>
        ...
        <div className="sync-progress-section">
          ...
          <div className="progress-labels">
            <span className="progress-count">{indexedFiles} of {totalFiles} files</span>
